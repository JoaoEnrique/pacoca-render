            ...
            <div class="col">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="flex-direction: row; justify-content: space-evenly; width: 100%;">
                    ...
                    {{-- Usuario Logado mostra icones de configurações  --}}
                        ...
                        {{-- CRIAR POST --}}
                        <li class="nav-item">
                            <a  type="button" @if(!$email_verify && auth()->check()) data-bs-toggle="modal" data-bs-target="#modal-verificar-email" @else data-bs-toggle="modal" data-bs-target="#modal-post" @endif class="nav-link" href="/">
...
<div class="col-10">
    <form class="d-inline" id="form-open-loading" method="POST" action="{{ route('verification.send') }}">
        @csrf
        {{-- video/mp4, video/webm --}}
        {{-- Campo de texto --}}
        ...
        <div class="modal fade" id="modal-verificar-email" tabindex="-1" aria-labelledby="modal-verificar-email" aria-hidden="true">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn-blue">Enviar link por email</button>
